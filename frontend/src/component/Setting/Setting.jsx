...
const Setting = () => {
          ...
          .then((refreshResponse) => {
            ...
            fetch(`${apiUrl}/api/users/profile/`, {
              ...
              if (response.ok) {
                ...
                setErrors("Error fetching user data after token refresh");
  ...
  const validateGeneralForm = () => {
    ...
    if (!username) {
      ...
      newErrors.username = "must be 3-15 characters long.";
    } else if (!/^[a-zA-Z0-9-]+$/.test(username)) {
      newErrors.username = "only letters, numbers, and hyphens.";
    }

    if (bio?.length >= 150) {
      newErrors.bio = "must be less than 150 characters.";
    }
        ...
        <div className="settings-forms">
          ...
          <div className="settings-forms-container">
            {general ? (
              ...
              className="form-general" key="general-form">
